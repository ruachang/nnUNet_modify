...
from nnunet_test.training.nnUNetTrainer.nnFormerTrainer import nnFormerTrainer 
...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
    ...
    # assert issubclass(nnunet_trainer, nnUNetTrainer), 'The requested nnunet trainer class is {} while the getting one is {} \
    #                                                 must inherit from '  'nnUNetTrainer'.format(nnunet_trainer, nnUNetTrainer)
...
def maybe_load_checkpoint(nnunet_trainer, continue_training: bool, validation_only: bool,
