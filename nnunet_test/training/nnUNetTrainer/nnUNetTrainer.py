...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        # Generate from the plan => plan still needed
    ...
    # ! build loss function
    # the loss function depends on whether using regions
    ...
    def configure_rotation_dummyDA_mirroring_and_inital_patch_size(self):
        # configure rotation and mirroring for data augmentation and preprocess
        # will this be confilct with the input?
        """
    ...
    def do_split(self):
    # only to change when want to create the new type of split
        """
    ...
    # one step for train: include infer, loss, backward, optimizer step
    # add an clip in the last part of it
        data = batch['data']
        target = batch['target']
    ...
    # change the model's mode
        self.network.eval()

    def validation_step(self, batch: dict) -> dict:
    # tep of validate
    # ! add something more about label manager,background edit
    # ! slice both the output and the loss
    # maybe the validation is required to output in the form of dictionary
        data = batch['data']
        target = batch['target']
    ...
    # using collect output to get the loss for each batch
