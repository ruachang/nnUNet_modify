...
class SegmentationNetwork(NeuralNetwork):
    ...
    def predict_3D(self, x: np.ndarray, do_mirroring: bool, mirror_axes: Tuple[int, ...] = (0, 1, 2),
        ...
        # * mixed_precision: whether use mixed precision to accelerate
        ...
        if mixed_precision:
            context = autocast
        # else:
        #     # ! can not find replacement, just delete it
        #     context = no_op
