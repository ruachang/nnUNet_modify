...
(PowerShell)
```PowerShell
$Env:nnUNet_raw = "F:\dataset\mindBoggle\nnUNet_raw"
$Env:nnUNet_preprocessed = "F:\dataset\mindBoggle\nnUNet\my_nnunet\nnUNet_preprocessed"
$Env:nnUNet_results = "F:\dataset\mindBoggle\nnUNet\my_nnunet\nnUNet_results"
```

(Command Prompt)
```Command Prompt
set nnUNet_raw=F:\dataset\mindBoggle\nnUNet_raw
set nnUNet_preprocessed="F:\dataset\mindBoggle\nnUNet\my_nnunet\nnUNet_preprocessed"
set nnUNet_results="F:\dataset\mindBoggle\nnUNet\my_nnunet\nnUNet_results"
```
